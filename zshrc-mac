...
plugins=(osx xcode ant brew brew-cask cp django docker emacs colored-man-pages encode64 bundler extract ruby python github svn rails gem git git-flow git-extras golang httpie lein macports mercurial mvn mysql-macports nmap npm nvm node pip macx postgres rake rake-fast rsync sbt scala z web-search sudo zsh-navigation-tools supervisor systemadmin )
...
export ANACONDA_HOME="/Users/r0b1n/anaconda2"
export TEX_HOME="Library/Tex"

export PATH="/sbin:/bin:/usr/sbin:$CELLAR_HOME/qt/4.8.7_2/bin:$CELLAR_HOME/python3/3.5.1/bin:/usr/local/bin:/opt/local/sbin:/opt/local/bin:/usr/bin:$ANACONDA_HOME/bin:$SCALA_HOME/bin:$SPARK_HOME/bin:$TEX_HOME/texbin:/opt/X11/bin:$GO_PATH/bin:$CLOJURE_HOME:$ANDROID_HOME/tools:."
